			...
			if (edit == false) {
				...
				try {
					...
					if (anadir) {
						...
						JOptionPane.showMessageDialog(this, "ERROR", "Imposible to Add Pecera", JOptionPane.INFORMATION_MESSAGE);
				...
				try {
					...
					if (anadir) {
						...
						JOptionPane.showMessageDialog(this, "ERROR", "Imposible to Edit Pecera", JOptionPane.INFORMATION_MESSAGE);
					}
