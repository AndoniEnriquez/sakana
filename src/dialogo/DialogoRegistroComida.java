...
public class DialogoRegistroComida extends JDialog implements ListSelectionListener {
	...
	private Container crearPanelDatos() {
		...
		panel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
		panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.CYAN), "Datos Pecera"));
	...
	private void crearTabla() {
		...
		if (tabla.getRowCount() > 0) vTabla.setRowSelectionInterval(0, 0);
