		...
		case "OK":
			...
			if (edit == false) {
				...
				try {
					...
					TipoPez tp = new TipoPez(txNombretipoPez.getText(), Float.parseFloat(txPhMin.getText()),
							Float.parseFloat(txPhMax.getText()), Float.parseFloat(txTempMin.getText()),
							Float.parseFloat(txTempMax.getText()));
					...
					if (anadir) {
						...
						JOptionPane.showMessageDialog(this, "ERROR", "Imposible to Add TipoPez", JOptionPane.INFORMATION_MESSAGE);
					}
				...
				try {
					...
					if (anadir) {
						...
						JOptionPane.showMessageDialog(this, "ERROR", "Imposible to Edit TipoPez", JOptionPane.INFORMATION_MESSAGE);
